...
def play_game():
  ...
  while not is_game_over:   
    ...
    if user_score==0 and computer_score==0 and sum(cards)>21:
      is_game_over=True
    else:
      user_should_deal=input("Type 'y' if you want new card,type 'n' to pass ")
...
while input("Do you want to play the game blackjack? type 'y' and 'n'")=="y":
  clear()
  play_game()
